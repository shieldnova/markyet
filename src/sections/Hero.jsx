        ...
        <div className='max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            ...
            <div>
                ...
                <div className="mt-8 flex gap-4">
                    <a href="#contact" class="px-6 py-3 rounded-full bg-markyetcolor hover:bg-markyetcolor text-white font-medium">Get Started</a>
                    <a href="#services" class="px-6 py-3 rounded-full border border-markyetcolor text-markyetcolor font-medium hover:bg-violet-50">Our Services</a>
                </div>                
            </div>
            {/*End of Left Section*/}
            {/*Right Side Image*/}
